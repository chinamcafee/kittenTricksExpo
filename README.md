# Kitten Tricks With Expo SDK 40 and UI Kitten library V5 [<img src="https://i.imgur.com/oMcxwZ0.png" alt="Eva Design System" height="20px" />][link:eva] [![Build Status][badge:github-actions]][link:github-actions] [![runs with expo][badge:expo]][link:expo] [![Netlify Status][badge:netlify]][link:netlify]

# Thanks
This repo is based on nvtienanh's work:
 https://github.com/nvtienanh/kittenTricks/tree/v2.5 
# How to run:
- Install the dependency and Just use: expo start
